...
function liveStatement(detail: PathDetail) {
 ...
 *
 * Fica no escopo do módulo, e não dentro do componente, porque `session.tsx`
 * precisa da MESMA resposta para saber se o paciente está olhando a tela. Duas
 * cópias da regra divergiriam, e a que divergisse mostraria ao paciente algo
 * que só o cuidador deveria ver.
 */
 ...
 * apresentadas e a frase aguardando o SIM. Em todo o resto — compor, revisar,
 * navegar, ver o registro pronto — a tela é do cuidador.
 */
