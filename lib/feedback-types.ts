...
export type FeedbackConversationStatus = "open" | "resolved";
export type FeedbackResolutionSource = "user" | "admin";
...
export interface FeedbackRequest {
  ...
  isOwner: boolean;
  archived: boolean;
  /** Independente do andamento da solicitação (status). */
