...
export type InteractionEventType =
  ...
  | "QUESTION_CANCELED"
  // ——— Conversa por opções (Fases 4.1, 4.3–4.6) ———
  // Mesma trilha, mesma coleção, mesmo writeAudit: o histórico de um paciente
  // é UM só, e uma pergunta fechada e um nível de opções aparecem lado a lado
